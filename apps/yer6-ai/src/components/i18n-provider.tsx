...
export const tr: Record<string, string> = {
  ...
  "Job title": "Görev / unvan",
  "Country": "Ülke",
  "City": "Şehir",
  "Phone (optional)": "Telefon (isteğe bağlı)",
  "I accept the privacy notice and terms of use.": "Gizlilik bildirimini ve kullanım şartlarını kabul ediyorum.",
  "Passwords do not match.": "Şifreler birbiriyle uyuşmuyor.",
  "Password must be at least 12 characters and include letters and numbers.": "Şifre en az 12 karakter olmalı; harf ve rakam içermelidir.",
  "Registration is currently closed.": "Kayıt şu anda kapalıdır.",
  "Too many attempts. Please wait a minute and try again.": "Çok fazla deneme yapıldı. Lütfen bir dakika bekleyip tekrar deneyin.",
  "Check your details and try again.": "Bilgilerinizi kontrol edip tekrar deneyin.",
  "Your registration was received. Verify your email, then sign in.": "Kaydınız alındı. E-postanızı doğrulayıp giriş yapın.",
  "If this email is available, your account has been created. Try signing in.": "Bu e-posta kullanılabilir durumdaysa hesabınız oluşturuldu. Giriş yapmayı deneyin.",
  "Creating account...": "Hesap oluşturuluyor...",
  "Password reset links are sent once an email provider is configured. Please contact your administrator.": "Şifre sıfırlama bağlantıları, e-posta sağlayıcısı yapılandırıldığında gönderilir. Lütfen yöneticinizle iletişime geçin.",
  "Founder": "Kurucu",
  "Founder profile": "Kurucu profili",
  "My profile": "Profilim",
  ...
  "Full access": "Tam erişim için giriş yapın",
...
export const ar: Record<string, string> = {
  ...
  "Password (again)": "كلمة المرور (تأكيد)",
  "Company name": "اسم الشركة",
  "Job title": "المسمى الوظيفي",
  "Country": "الدولة",
  "City": "المدينة",
  "Phone (optional)": "الهاتف (اختياري)",
  "I accept the privacy notice and terms of use.": "أوافق على إشعار الخصوصية وشروط الاستخدام.",
  "Passwords do not match.": "كلمتا المرور غير متطابقتين.",
  "Password must be at least 12 characters and include letters and numbers.": "يجب ألا تقل كلمة المرور عن 12 حرفاً وأن تتضمن أحرفاً وأرقاماً.",
  "Registration is currently closed.": "التسجيل مغلق حالياً.",
  "Too many attempts. Please wait a minute and try again.": "محاولات كثيرة جداً. يرجى الانتظار دقيقة ثم المحاولة مجدداً.",
  "Check your details and try again.": "تحقق من بياناتك وحاول مرة أخرى.",
  "Your registration was received. Verify your email, then sign in.": "تم استلام تسجيلك. فعّل بريدك الإلكتروني ثم سجّل الدخول.",
  "If this email is available, your account has been created. Try signing in.": "إذا كان هذا البريد متاحاً فقد أُنشئ حسابك. جرّب تسجيل الدخول.",
  "Creating account...": "جارٍ إنشاء الحساب...",
  "Password reset links are sent once an email provider is configured. Please contact your administrator.": "تُرسل روابط إعادة تعيين كلمة المرور بعد تهيئة مزوّد البريد الإلكتروني. يرجى التواصل مع المسؤول.",
  "Founder": "المؤسس",
  "Founder profile": "ملف المؤسس",
  "My profile": "ملفي الشخصي",
  "Account & security": "الحساب والأمان",
  "Admin panel": "لوحة الإدارة",
  "Sign out": "تسجيل الخروج",
  "Account menu": "قائمة الحساب",
  "Signed in": "الجلسة مفتوحة",
  "Full access": "سجّل الدخول للوصول الكامل",
