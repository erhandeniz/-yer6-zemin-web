...
const districtSeeds: DistrictSeed[] = [
  ...
  // DENİZLİ / AYDIN / MANİSA / MUĞLA — Ege graben sistemleri ve kıyı jeolojisi
  { slug: "denizli-pamukkale-zemin-guclendirme", district: "Pamukkale", province: "Denizli", fault: "Pamukkale/Denizli graben fay sistemi", soil: "ova alüvyonu ve traverten/killi zeminler", risk: "karstik boşluk, jeotermal etki ve farklı oturma", methods: ["dsm", "jet-grout", "fore-kazik", "zemin-iyilestirme"], articles: A.dsm },
  { slug: "denizli-merkezefendi-zemin-guclendirme", district: "Merkezefendi", province: "Denizli", fault: "Denizli graben fay zonu", soil: "alüvyon çökelleri ve kentsel dönüşüm dolguları", risk: "sanayi ve konut yapılarında oturma ve taşıma gücü", methods: ["fore-kazik", "jet-grout", "dsm", "zemin-iyilestirme"], articles: A.jet },
  ...
  { slug: "aydin-incirliova-zemin-guclendirme", district: "İncirliova", province: "Aydın", fault: "Büyük Menderes graben fayı", soil: "Menderes havzası sert kumlu ve siltli alüvyon, yüksek yeraltı suyu", risk: "otopark ve meydan kazılarında su basması, oturma ve sıvılaşma", methods: ["jet-grout", "fore-kazik", "dsm", "zemin-iyilestirme"], articles: A.jet },
  { slug: "aydin-kusadasi-zemin-guclendirme", district: "Kuşadası", province: "Aydın", fault: "Kuşadası Körfezi ve Sisam fay zonu (2020 deprem etkisi)", soil: "kıyı dolgusu, turizm yapıları yamaç molozu ve zayıf kumtaşı-kil geçişleri", risk: "otel ve rezidans yapılarında şev kayması, deniz etkisi ve oturma", methods: ["fore-kazik", "ankraj", "jet-grout", "iksa-sistemleri"], articles: A.jet },
  { slug: "aydin-didim-zemin-guclendirme", district: "Didim", province: "Aydın", fault: "Menderes deltası fay kolları", soil: "kıyı kumulu, doygun gevşek alüvyon ve kireçli çökeller", risk: "yüksek sıvılaşma potansiyeli ve kıyı yapılarında oturma", methods: ["jet-grout", "dsm", "tas-kolon", "zemin-iyilestirme"], articles: A.liq },
  { slug: "aydin-soke-zemin-guclendirme", district: "Söke", province: "Aydın", fault: "Büyük Menderes graben fayı ve Priene fay segmenti", soil: "Büyük Menderes deltası derin kalın alüvyonu, suya doygun mil ve kil", risk: "ağır sanayi ve çimento tesislerinde yüksek sıvılaşma ve aşırı konsolidasyon oturması", methods: ["dsm", "jet-grout", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "aydin-nazilli-zemin-guclendirme", district: "Nazilli", province: "Aydın", fault: "Büyük Menderes graben kuzey fayı", soil: "ova alüvyonu ve organize sanayi dolguları", risk: "fay yakınlığı, sıvılaşma ve endüstriyel platform oturması", methods: ["dsm", "jet-grout", "fore-kazik", "zemin-iyilestirme"], articles: A.dsm },
  { slug: "mugla-milas-zemin-guclendirme", district: "Milas", province: "Muğla", fault: "Milas–Ören fay zonu ve Güllük grabeni", soil: "Güllük deltası ve ova alüvyonu, zeytinlik/tarım dönüşüm zeminleri", risk: "organize sanayi, lojistik depolar ve kıyı tesislerinde sıvılaşma ve oturma", methods: ["jet-grout", "dsm", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "mugla-bodrum-zemin-guclendirme", district: "Bodrum", province: "Muğla", fault: "Gökova körfezi fay sistemi ve Karaada fayı", soil: "eğimli yamaç kireçtaşı, ayrışmış volkanik kaya ve kıyı dolgusu", risk: "villa ve otel projelerinde derin kazı iksa, şev stabilitesi ve temel altı kaya ankrajı", methods: ["fore-kazik", "mini-kazik", "ankraj", "iksa-sistemleri"], articles: A.jet },
  { slug: "mugla-marmaris-zemin-guclendirme", district: "Marmaris", province: "Muğla", fault: "Rodos–Marmaris dalma-batma zonu etki alanı", soil: "kıyı alüvyonu, deniz dolgusu ve yüksek yeraltı suyu", risk: "deniz suyu geçirimsizliği, marina ve otel temellerinde oturma", methods: ["jet-grout", "mini-kazik", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "mugla-fethiye-zemin-guclendirme", district: "Fethiye", province: "Muğla", fault: "Fethiye–Burdur fay zonu", soil: "ova alüvyonu, doygun kum-silt ve kıyı çökelleri", risk: "yüksek sıvılaşma ve taşıma gücü yetersizliği", methods: ["jet-grout", "dsm", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "mugla-mentese-zemin-guclendirme", district: "Menteşe", province: "Muğla", fault: "Muğla fay zonu", soil: "karstik kireçtaşı platosu ve killi vadi zeminleri", risk: "karstik erime boşlukları ve kamu/konut temellerinde farklı oturma", methods: ["fore-kazik", "jet-grout", "mini-kazik", "zemin-iyilestirme"], articles: A.jet },
  { slug: "manisa-yunusemre-zemin-guclendirme", district: "Yunusemre", province: "Manisa", fault: "Gediz (Manisa) graben fayı", soil: "Gediz ovası alüvyonu ve Manisa OSB dolguları", risk: "sıvılaşma ve ağır fabrika yüklerinde oturma", methods: ["dsm", "jet-grout", "tas-kolon", "zemin-iyilestirme"], articles: A.liq },
  { slug: "manisa-akhisar-zemin-guclendirme", district: "Akhisar", province: "Manisa", fault: "Gediz graben sistemi", soil: "ova alüvyonu ve killi-kumlu tabakalar", risk: "oturma ve sıvılaşma", methods: ["dsm", "jet-grout", "tas-kolon", "zemin-iyilestirme"], articles: A.dsm },
  ...
  // İZMİR — Genişletilmiş Ege kıyı ve sanayi aksları
  { slug: "izmir-cesme-zemin-guclendirme", district: "Çeşme", province: "İzmir", fault: "Sakız–Çeşme fay zonu", soil: "kıyı marinası dolgusu, kireçtaşı ve kum ardalanması", risk: "marina, otel ve lüks konutlarda deniz suyu sızdırmazlığı, şev ve temel güçlendirme", methods: ["mini-kazik", "fore-kazik", "ankraj", "jet-grout"], articles: A.jet },
  { slug: "izmir-urla-zemin-guclendirme", district: "Urla", province: "İzmir", fault: "Gülbahçe fay zonu (aktif sismik hat)", soil: "kıyı alüvyonu ve eğimli killi-kireçli zeminler", risk: "villa temellerinde sıvılaşma, oturma ve derin kazı stabilitesi", methods: ["mini-kazik", "jet-grout", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "izmir-aliaga-zemin-guclendirme", district: "Aliağa", province: "İzmir", fault: "Zeytindağ–Aliağa fay kolları", soil: "ağır sanayi dolgusu, rafineri ve petrokimya kıyı çökelleri", risk: "ağır endüstriyel tesisler, tank temelleri ve rıhtımlarda aşırı oturma ve sıvılaşma", methods: ["fore-kazik", "dsm", "jet-grout", "zemin-iyilestirme"], articles: A.liq },
  { slug: "izmir-torbali-zemin-guclendirme", district: "Torbalı", province: "İzmir", fault: "Küçük Menderes graben fay sistemi", soil: "Küçük Menderes ovası kalın alüvyon ve fabrika dolgu sahaları", risk: "büyük ölçekli üretim tesislerinde zemin taşıma gücü ve oturma kontrolü", methods: ["dsm", "jet-grout", "fore-kazik", "tas-kolon"], articles: A.dsm },
  { slug: "izmir-seferihisar-zemin-guclendirme", district: "Seferihisar", province: "İzmir", fault: "Tuzla fayı / Seferihisar fay zonu (2020 tsunami ve deprem hattı)", soil: "kıyı dolgusu, balçık ve doygun kum çökelleri", risk: "kıyı bandında yüksek sıvılaşma, zemin göçmesi ve deniz suyu etkisi", methods: ["jet-grout", "fore-kazik", "dsm", "zemin-iyilestirme"], articles: A.liq },
  { slug: "izmir-kemalpasa-zemin-guclendirme", district: "Kemalpaşa", province: "İzmir", fault: "Kemalpaşa graben kenar fayı", soil: "OSB lojistik alanları ve ova alüvyonu", risk: "lojistik depo platformlarında farklı oturma", methods: ["dsm", "jet-grout", "fore-kazik", "zemin-iyilestirme"], articles: A.dsm },

  // BALIKESİR / ÇANAKKALE — KAF Güney Kolu, Edremit Körfezi ve Çanakkale Boğazı
  { slug: "balikesir-bandirma-zemin-guclendirme", district: "Bandırma", province: "Balıkesir", fault: "KAF Marmara güney kolu (Edincik fayı)", soil: "körfez kıyısı alüvyon, liman ve gübre/kimya sanayi dolgusu", risk: "sıvılaşma, liman yüklerinde oturma ve sismik büyütme", methods: ["jet-grout", "dsm", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "balikesir-edremit-zemin-guclendirme", district: "Edremit", province: "Balıkesir", fault: "Edremit Körfezi fayı ve Havran–Balıkesir fay zonu", soil: "Edremit ovası kalın alüvyonu, kıyı kumulları ve yüksek su seviyesi", risk: "yoğun konut ve turizm projelerinde yüksek sıvılaşma ve oturma", methods: ["jet-grout", "fore-kazik", "dsm", "zemin-iyilestirme"], articles: A.liq },
  { slug: "balikesir-ayvalik-zemin-guclendirme", district: "Ayvalık", province: "Balıkesir", fault: "Midilli–Ayvalık fay sistemi", soil: "kıyı dolgusu, lagün çökelleri ve denizel kum", risk: "deniz suyu geçirimsizliği, sıvılaşma ve tarihi/modern temel güçlendirme", methods: ["jet-grout", "mini-kazik", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "balikesir-burhaniye-zemin-guclendirme", district: "Burhaniye", province: "Balıkesir", fault: "Edremit fayı güney kolu", soil: "kıyı ovası gevşek kum-silt alüvyonu", risk: "sıvılaşma ve diferansiyel oturma", methods: ["jet-grout", "dsm", "tas-kolon", "zemin-iyilestirme"], articles: A.liq },
  { slug: "balikesir-altieylul-zemin-guclendirme", district: "Altıeylül", province: "Balıkesir", fault: "Balıkesir fay zonu (Gökçeyazı segmenti)", soil: "Balıkesir ovası killi-siltli alüvyon ve Balıkesir OSB dolgu alanları", risk: "sanayi döşemeleri ve konut yapılarında oturma", methods: ["dsm", "jet-grout", "fore-kazik", "zemin-iyilestirme"], articles: A.dsm },
  { slug: "balikesir-karesi-zemin-guclendirme", district: "Karesi", province: "Balıkesir", fault: "Balıkesir fay zonu", soil: "kentsel dönüşüm alanları, heterojen dolgu ve killi zemin", risk: "farklı oturma ve temel güçlendirme", methods: ["fore-kazik", "jet-grout", "mini-kazik", "zemin-iyilestirme"], articles: A.jet },
  { slug: "canakkale-merkez-zemin-guclendirme", district: "Çanakkale Merkez", province: "Çanakkale", fault: "KAF Biga/Marmara güney kolu ve Saros fay zonu", soil: "Sarıçay deltası alüvyonu, boğaz kıyı dolgusu ve doygun kum", risk: "yüksek sıvılaşma ve kıyı yapılarında taşıma gücü yetersizliği", methods: ["jet-grout", "dsm", "fore-kazik", "zemin-iyilestirme"], articles: A.liq },
  { slug: "canakkale-biga-zemin-guclendirme", district: "Biga", province: "Çanakkale", fault: "KAF Biga–Çan fay segmenti", soil: "Biga Çayı taşkın ovası alüvyonu, ağır sanayi ve OSB platformları", risk: "demir-çelik, enerji ve sanayi tesislerinde yüksek oturma ve sıvılaşma", methods: ["dsm", "fore-kazik", "jet-grout", "zemin-iyilestirme"], articles: A.dsm },
  { slug: "canakkale-gelibolu-zemin-guclendirme", district: "Gelibolu", province: "Çanakkale", fault: "KAF Ganos fayı ve Saros grabeni", soil: "Boğaz kıyı dolgusu, eğimli yamaç molozları ve killi çökeller", risk: "liman, lojistik ve 1915 Çanakkale Köprüsü aksı yapılarında şev ve oturma kontrolü", methods: ["fore-kazik", "ankraj", "jet-grout", "iksa-sistemleri"], articles: A.jet },
  { slug: "canakkale-can-zemin-guclendirme", district: "Çan", province: "Çanakkale", fault: "Çan–Biga fay zonu", soil: "vadi alüvyonu, killi tabakalar ve seramik sanayi sahaları", risk: "ağır fabrika yükleri altında farklı oturma ve fay etkisi", methods: ["dsm", "jet-grout", "fore-kazik", "zemin-iyilestirme"], articles: A.dsm },
  { slug: "canakkale-ayvacik-zemin-guclendirme", district: "Ayvacık", province: "Çanakkale", fault: "Gülpınar–Ayvacık sismik kaynakları (2017 deprem dizisi)", soil: "volkanik kaya üzeri zayıf örtü ve kıyı dolguları", risk: "sismik aktivite altında yamaç stabilitesi ve temel güçlendirme", methods: ["mini-kazik", "fore-kazik", "ankraj", "zemin-iyilestirme"], articles: A.jet },
  ...
  { slug: "ankara-bala-zemin-guclendirme", district: "Balâ", province: "Ankara", fault: "Balâ fay zonu ve yerel zemin koşulları", soil: "karayolu dolguları, killi-siltli heterojen tabakalar", risk: "karayolu dolgularında oturma, şev kayması ve ağır dingil yükü deformasyonu", methods: ["jet-grout", "fore-kazik", "ankraj", "zemin-iyilestirme"], articles: A.jet },
