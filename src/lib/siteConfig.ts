export const siteConfig = {
  ...
  companyName: "YER6 Zemin Geoteknik Mühendislik",
  ...
  whatsapp: {
    ...
    message: "Merhaba YER6 Zemin Geoteknik Mühendislik, zemin güçlendirme hizmetleri hakkında bilgi ve fiyat teklifi almak istiyorum."
  },
