...
export const services = [
  {
    ...
    faq: [
      ...
      { question: "Jet grout makinesi kiralama ve şantiye mobilizasyon maliyeti nasıl hesaplanır?", answer: "Jet grout makine kiralama maliyeti; hidrolik delgi rigi ve 400-600 bar yüksek basınç pompasının takım kirası, çift yönlü lowbed ağır nakliyesi, saatlik 45-75 lt mazot sarfiyatı ve aşınan yüksek basınç parçalarıyla hesaplanır. Projelerde arıza duruşu ve zayiat riskini sıfırlamak için YER6'dan anahtar teslim metre bazlı taahhüt almak çok daha ekonomiktir." },
      { question: "Jet grout makinesi satın almak veya kiralamak mı, anahtar teslim taahhüt mü daha avantajlıdır?", answer: "Makine kiralandığında arıza duruşları, kuyu göçmesi, çimento zayiatı ve testten geçmeyen kolon riski tamamen müteahhide aittir. YER6 anahtar teslim taahhüdünde ise arıza ve ekipman riski firmamıza aittir; müteahhit yalnızca akredite laboratuvar ve karot kabulünden geçen sağlam kolon metresi için ödeme yapar." }
    ]
  },
  {
    slug: "dsm",
    ...
    faq: [
      ...
      { question: "DSM zemin iyileştirme metre fiyatı ve 2026 maliyetleri neye göre belirlenir?", answer: "DSM birim fiyatı; kolon çapı (Ø60-Ø100 cm), kolon derinliği, zeminin su muhtevası ve m³ başına bağlayıcı dozajına (150-300 kg çimento/m³) göre hesaplanır. Geniş endüstriyel zeminlerde hafriyat ve çamur tahliyesi gerektirmediği için Jet Grout'a kıyasla %30-40, Fore Kazık'a kıyasla %50'ye varan maliyet avantajı sağlar." },
      { question: "DSM kalite kontrolünde karot alma ve UCS test kriterleri nelerdir?", answer: "ASTM D2166 ve EN 14679 standartlarına göre imalattan 28 gün sonra prizini almış kolonlardan karot alınır. Laboratuvarda Serbest Basınç Dayanımı (UCS) kırım testleri uygulanarak 1.0 - 3.5 MPa tasarım dayanımı doğrulanır. İmalat esnasında ise data logger ile Blade Rotation Number (BRN) karıştırma enerjisi izlenir." },
      { question: "Lojistik depo ve fabrika zeminlerinde DSM neden fore kazıktan daha avantajlıdır?", answer: "Geniş taban alanına sahip endüstriyel tesislerde noktasal kazıklar yerine tüm zemin kütlesini üniform olarak güçlendiren DSM kafes sistemleri diferansiyel oturmayı sıfıra indirir. Günlük 400-600 metreye varan yüksek üretim hızıyla proje teslim süresini yarıya indirir." },
  ...
  },
  {
    ...
    processSteps: [
      ...
      { title: "Tremie Yöntemi ile Beton Dökümü", description: "Beton, suyun veya bentonitin altında kalmayacak şekilde dipten yukarı tremie borusuyla dökülür. EFFC/DFI kılavuzları ve TS EN 1536 uyarınca tremie borusu ucu döküm boyunca sürekli taze beton içinde 1.5 ila 3.0 metre aralığında gömülü tutulur." },
    ...
    technicalNote: "Fore kazık imalatında kalite, delgi hızından çok beton döküm disiplinine bağlıdır. EFFC/DFI 'Tremie Concrete Guide' ve TS EN 1536 standartlarına göre; tremie borusunun beton dökümü süresince taze beton içinde 1.5 ila 3.0 metre aralığında gömülü tutulması en iyi mühendislik uygulaması kabul edilir. Bu kural, kuyu çamuru karışmasını ve soğuk derz oluşumunu önler. Ayrıca Düşük Gerinimli Bütünlük (PIT) testleri kazık gövde sürekliliğini doğrular; eksenel taşıma kapasitesi ise Statik veya Dinamik Yükleme Deneyleri ile teyit edilir.",
    faq: [
      { question: "Fore kazık kaç şiddetinde depreme dayanır?", answer: "Mühendislik hesaplarında deprem dayanımı Richter büyüklüğü yerine Zemin İvmesi (PGA) ve TBDY 2018 spektral ivme parametreleri (S_DS, S_D1) ile boyutlandırılır. Sağlam ana kayaya geoteknik tasarımda hesaplanan derinlikte soketlenen ve donatılı projelendirilen bir fore kazık sistemi; 0.60g - 0.80g yer ivmesine (7.5 - 8.0+ Mw büyüklüğündeki yıkıcı depremlere) tam dayanım gösterecek kapasiteye ulaştırılır. Yüzeydeki alüvyon tabakası sıvılaşsa dahi yükü derindeki rijit tabakaya ilettiği için yapının devrilmesini ve oturmasını mühendislik sınırları içinde tutar." },
      { question: "Fore kazık mı radye temel mi? Hangi durumda hangisi seçilmelidir?", answer: "Radye temel ve fore kazık birbirinin rakibi değil; zemin sınıfı, yapı yükleri ve izin verilen oturma sınırlarına göre birbirini tamamlayan sistemlerdir. ZA, ZB ve sıkı ZC zeminlerde yapı yükleri elverdiği sürece radye temel öncelikli ve ekonomiktir. Yumuşak kil, dolgu, yüksek yeraltı suyu veya sıvılaşma potansiyeli taşıyan ZD, ZE ve ZF zeminlerde ise farklı oturma ve taşıma yetersizliklerine karşı derin temel (kazıklı radye) veya zemin iyileştirme (DSM, Jet Grout) sistemleri uygulanarak yapı-zemin etkileşimi güvenceye alınır." },
      { question: "Fore kazık ve radye temel arasındaki temel farklar nelerdir?", answer: "Radye temel yüzey taban temas gerilmesiyle yük aktarırken, fore kazık derin tabakalara uç mukavemeti ve çevre sürtünmesi kombinasyonuyla yük iletir. Sıvılaşabilir ve zayıf zeminlerde yüzeysel temeller toptan göçme veya farklı oturma riski taşırken, fore kazık derin taşıyıcı katmanlara kilitlenerek deprem anında yapısal stabiliteyi korur." },
      { question: "Çaplarına göre fore kazıklar (Ø65, Ø80, Ø100, Ø120 cm) nerelerde tercih edilir?", answer: "Çap seçimi; üstyapı statik yükleri, kolon eksenel kuvvetleri, yanal deprem momentleri ve zemin profiline göre geoteknik proje mühendisi tarafından optimize edilir. Tipik olarak orta yükler ve kentsel dönüşümde Ø65–Ø80 cm; yüksek yapılar ve derin iksalarda Ø100 cm; köprü ayakları, viyadük ve ağır altyapı işlerinde ise Ø120 cm ve üzeri çaplar boyutlandırılır." },
...
export const standaloneServices = [
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "DSM zemin iyileştirme metre fiyatı ve 2026 maliyetleri neye göre belirlenir?", answer: "DSM birim fiyatı; kolon çapı (Ø60-Ø100 cm), imalat derinliği, zeminin su muhtevası ve çimento sarfiyatına (150-300 kg/m³) göre hesaplanır. Büyük sanayi sahalarında hafriyat atığı oluşturmadığı için Jet Grout'a göre %30-40, Fore Kazık'a göre %50 daha ekonomiktir." },
      { question: "DSM kalite kontrolünde karot alma ve UCS test kriterleri nelerdir?", answer: "ASTM D2166 ve EN 14679 standartlarına göre imalattan 28 gün sonra kolon gövdesinden karot alınır. Laboratuvarda Serbest Basınç Dayanımı (UCS) kırım testleri yapılarak 1.0 - 3.5 MPa tasarım dayanımı belgelenir. İmalat sırasında data logger ile karıştırma enerjisi (BRN) kesintisiz kaydedilir." },
      { question: "Lojistik depo ve sanayi yapılarında DSM neden fore kazığa tercih edilir?", answer: "Geniş taban alanına sahip tesislerde zemin kütlesini grid (kafes) halinde monolitik bir blok olarak güçlendirir. Diferansiyel oturmaları sıfırlarken, fore kazığa kıyasla günlük 400-600 metre imalat hızıyla şantiye takvimini ciddi oranda kısaltır." },
...
const projectCatalog = [
  ...
  },
  {
    ...
    title: "Marmara Lojistik Merkezi DSM Zemin Güçlendirme",
    summary: "YER6 Geoteknik tarafından Kocaeli'de 42.000 metre tül DSM zemin kolonu ile bizzat imal edilen yüksek taşıma kapasiteli endüstriyel lojistik platformu.",
    ...
    solutionMethod: "YER6 Geoteknik çift milli DSM makineleriyle tüm tesis alanında 42.000 metre tül zemin-çimento kolonu bizzat imal edildi. Laboratuvar karışım tasarımı sonrası saha üretimi başlatıldı; her kolona ait üretim verisi dijital olarak kayıt altına alındı. Karot testleri ile kolon mukavemeti doğrulandı.",
    technicalInfo: [
  ...
  },
  {
    ...
    image: "/images/projects/saha/konut-fore-kazik-02.webp",
    imageAlt: "İstanbul karma kullanım kulesi projesinde Bauer BG 28 rotary delgi makinesi ile büyük çaplı fore kazık derin temel imalatı — YER6",
  ...
  {
    slug: "malatya-deprem-konutlari-fore-kazik",
    key: "proj_malatya_fore",
    category: "Fore Kazık",
    location: "Battalgazi / Malatya",
    year: "2025",
    area: "Deprem Konutları Yerleşkesi",
    metric: "Rotary Delgi · Kazıklı Radye Temel",
    title: "Malatya Deprem Konutları Fore Kazık ve Derin Temel Projesi",
    summary: "Malatya deprem konutları yerleşkesinde yüksek torklu rotary delgi makineleri ile zayıf zemin tabakalarını aşarak binaları ana kayaya kilitleyen fore kazık ve kazıklı radye temel imalatı.",
    ...
    technicalInfo: [
      { label: "Uygulama Yöntemi", value: "Büyük Çaplı Rotary Fore Kazık" },
      { label: "Lokasyon", value: "Battalgazi / Malatya" },
      { label: "Proje Tipi", value: "Kalıcı Deprem Konutları Derin Temeli" },
      { label: "Yönetmelik Uyumu", value: "TBDY 2018 & TS EN 1536" },
      { label: "Kalite Kontrol", value: "PIT (Kazık Bütünlük) ve beton basınç testleri" }
    ],
    ...
    video: {
      videoId: "-I5Nxlqsphs",
      title: "Malatya Deprem Konutları Fore Kazık Saha İmalat Videosu",
      caption: "Malatya deprem konutları sahasında rotary delgi makinesi ile fore kazık delgisi, donatı kafesi indirme ve tremie betonlama operasyonu.",
      orientation: "portrait" as const
    },
    gallery: [
  ...
  {
    slug: "hatay-arsuz-muhafaza-borulu-casing-fore-kazik",
    key: "proj_hatay_arsuz_casing",
    category: "Fore Kazık",
    location: "Arsuz / Hatay",
    year: "2025",
    area: "Sahil Şeridi & Kıyı Yapıları",
    metric: "Ø80/Ø100 cm Hidrolik Casing Delgi",
    ...
    technicalInfo: [
      { label: "Uygulama Yöntemi", value: "Muhafaza Borulu (Casing) Fore Kazık" },
      { label: "Lokasyon", value: "Arsuz / Hatay" },
      { label: "Kazık Çapları", value: "Ø80 cm ve Ø100 cm" },
      { label: "Zemin Şartı", value: "Yüksek Yeraltı Suyu & Gevşek Alüvyon" },
      { label: "Kalite Kontrol", value: "Kuyu düşeylik kontrolü, PIT testi ve numune deneyleri" }
    ],
    ...
    video: {
      videoId: "iABCGEeN8F8",
      title: "Hatay Arsuz Muhafaza Borulu Fore Kazık Videosu",
      caption: "Hatay Arsuz sahil sahasında çelik muhafaza borusu (casing) sürülerek gerçekleştirilen fore kazık delgi ve kuyu içi betonlama operasyonu.",
      orientation: "portrait" as const
    },
    gallery: [
